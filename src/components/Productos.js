        ...
        <div className="form-group">
          ...
          <div className="form-group col-md-4">
            ...
            <button
              ...
              className="btn btn-success m-2"
              onClick={handlePictureClick}>
              Cargar Imagen 4</button>
          </div>
          <div>
            <button className="btn btn-primary m-3">Guardar</button>
          </div>
          <div>
            <button type="button" className="btn btn-primary m-3" onClick={handleLogout}>
                Logout </button>
            <button onClick={() => dispatch(eliminarAsincrono(codigo))}>
                Eliminar </button>
            <button onClick={() => dispatch(eliminarAsincrono(codigo))}>
                Modificar </button>
          </div>
